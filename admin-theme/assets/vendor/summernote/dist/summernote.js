    ...
    var Codeview = function(a) {
        ...
        Buttons = function(a) {
            var b = this,
                ...
                h = this.representShortcut = function(a) {
                    var b = g[a];
                    return e.shortcuts && b ? (agent.isMac && (b = b.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")") : ""
                };
            this.initialize = function() {
        ...
        HelpDialog = function(a) {
            ...
            this.createShortCutList = function() {
                ...
                var a = e.dialogsInBody ? $(document.body) : d,
                    b = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.2</a> Â· ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> Â· ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
                this.$dialog = c.dialog({
